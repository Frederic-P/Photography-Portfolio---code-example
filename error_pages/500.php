...
<div class='mainpage' id='setbackimage'>
    <div id='error_container'>
        ...
        <br>
        <h1 class='error_message'>500 - Internal Server Error</h1>
        <p class='error_message'>Digital gremlins killed our server. This is my problem not yours.</p>
        <p class='error_message'>Consider contacting me or reload your page at a later moment. </p>
        <br>
        <br>
    </div>
    <div id='overlaycontain'>
        <img id='code' src='error_500code.png' alt='500-code'</div>
    </div>
</div>
</body>
</html>
